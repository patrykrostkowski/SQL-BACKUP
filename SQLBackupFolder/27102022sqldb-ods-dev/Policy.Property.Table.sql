USE [sqldb-ods-dev]
GO
/****** Object:  Table [Policy].[Property]    Script Date: 27.10.2022 12:27:07 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_AK1_Property]    Script Date: 27.10.2022 12:28:12 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_AK1_Property] ON [Policy].[Property]
(
	[SourceSystemSK] ASC,
	[SourceCode] ASC,
	[ProcessDateTime] ASC
...
GO
ALTER TABLE [Policy].[Property]  WITH NOCHECK ADD  CONSTRAINT [FK_CountrySK_Property] FOREIGN KEY([CountrySK])
REFERENCES [Typelist].[Country] ([CountrySK])
GO
ALTER TABLE [Policy].[Property] NOCHECK CONSTRAINT [FK_CountrySK_Property]
GO
ALTER TABLE [Policy].[Property]  WITH NOCHECK ADD  CONSTRAINT [FK_PolicyInsurableObjectSK_Property] FOREIGN KEY([PolicyInsurableObjectSK])
REFERENCES [Policy].[PolicyInsurableObject] ([PolicyInsurableObjectSK])
GO
ALTER TABLE [Policy].[Property] NOCHECK CONSTRAINT [FK_PolicyInsurableObjectSK_Property]
GO
ALTER TABLE [Policy].[Property]  WITH NOCHECK ADD  CONSTRAINT [FK_SourceSystemSK_Property] FOREIGN KEY([SourceSystemSK])
REFERENCES [Typelist].[SourceSystem] ([SourceSystemSK])
GO
ALTER TABLE [Policy].[Property] NOCHECK CONSTRAINT [FK_SourceSystemSK_Property]
GO
ALTER TABLE [Policy].[Property]  WITH NOCHECK ADD  CONSTRAINT [FK_StateSK_Property] FOREIGN KEY([StateSK])
REFERENCES [Typelist].[State] ([StateSK])
GO
ALTER TABLE [Policy].[Property] NOCHECK CONSTRAINT [FK_StateSK_Property]
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This is a supertype of an insurable property further defined by its many subtypes.  Examples inlcude dwelling, building' , @level0type=N'SCHEMA',@level0name=N'Policy', @level1type=N'TABLE',@level1name=N'Property'
GO
