...
GO
/****** Object:  Table [Production].[Product]    Script Date: 29.10.2022 10:42:14 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_Product_Name]    Script Date: 29.10.2022 10:42:14 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_Product_ProductNumber]    Script Date: 29.10.2022 10:42:14 ******/
CREATE UNIQUE NONCLUSTERED INDEX [AK_Product_ProductNumber] ON [Production].[Product]
(
	[ProductNumber] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [AK_Product_rowguid]    Script Date: 29.10.2022 10:42:14 ******/
