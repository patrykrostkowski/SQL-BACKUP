USE [sqldb-ods-dev]
GO
/****** Object:  Table [Policy].[Vehicle]    Script Date: 28.10.2022 15:05:01 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_AK1_Vehicle]    Script Date: 28.10.2022 15:06:00 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_AK1_Vehicle] ON [Policy].[Vehicle]
(
	[SourceSystemSK] ASC,
	[SourceCode] ASC,
	[ProcessDateTime] ASC
...
GO
ALTER TABLE [Policy].[Vehicle]  WITH NOCHECK ADD  CONSTRAINT [FK_PolicyInsurableObjectSK_Vehicle] FOREIGN KEY([PolicyInsurableObjectSK])
REFERENCES [Policy].[PolicyInsurableObject] ([PolicyInsurableObjectSK])
GO
ALTER TABLE [Policy].[Vehicle] NOCHECK CONSTRAINT [FK_PolicyInsurableObjectSK_Vehicle]
GO
ALTER TABLE [Policy].[Vehicle]  WITH NOCHECK ADD  CONSTRAINT [FK_RegistrationCountrySK_Vehicle] FOREIGN KEY([RegistrationCountrySK])
REFERENCES [Typelist].[Country] ([CountrySK])
GO
ALTER TABLE [Policy].[Vehicle] NOCHECK CONSTRAINT [FK_RegistrationCountrySK_Vehicle]
GO
ALTER TABLE [Policy].[Vehicle]  WITH NOCHECK ADD  CONSTRAINT [FK_RegistrationStateSK_Vehicle] FOREIGN KEY([RegistrationStateSK])
REFERENCES [Typelist].[State] ([StateSK])
GO
ALTER TABLE [Policy].[Vehicle] NOCHECK CONSTRAINT [FK_RegistrationStateSK_Vehicle]
GO
ALTER TABLE [Policy].[Vehicle]  WITH NOCHECK ADD  CONSTRAINT [FK_SourceSystemSK_Vehicle] FOREIGN KEY([SourceSystemSK])
REFERENCES [Typelist].[SourceSystem] ([SourceSystemSK])
GO
ALTER TABLE [Policy].[Vehicle] NOCHECK CONSTRAINT [FK_SourceSystemSK_Vehicle]
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This concept represents the features of most all types of vehicles.  It is generally defined to mean a device capable of transporting people or property which is self-propelled by mechanical or electrical power.' , @level0type=N'SCHEMA',@level0name=N'Policy', @level1type=N'TABLE',@level1name=N'Vehicle'
GO
