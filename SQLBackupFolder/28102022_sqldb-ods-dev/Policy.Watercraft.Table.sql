USE [sqldb-ods-dev]
GO
/****** Object:  Table [Policy].[Watercraft]    Script Date: 28.10.2022 15:05:03 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_AK1_Watercraft]    Script Date: 28.10.2022 15:06:00 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_AK1_Watercraft] ON [Policy].[Watercraft]
(
	[SourceSystemSK] ASC,
	[SourceCode] ASC,
	[ProcessDateTime] ASC
...
GO
ALTER TABLE [Policy].[Watercraft]  WITH NOCHECK ADD  CONSTRAINT [FK_PolicyInsurableObjectSK_Watercraft] FOREIGN KEY([PolicyInsurableObjectSK])
REFERENCES [Policy].[PolicyInsurableObject] ([PolicyInsurableObjectSK])
GO
ALTER TABLE [Policy].[Watercraft] NOCHECK CONSTRAINT [FK_PolicyInsurableObjectSK_Watercraft]
GO
ALTER TABLE [Policy].[Watercraft]  WITH NOCHECK ADD  CONSTRAINT [FK_SourceSystemSK_Watercraft] FOREIGN KEY([SourceSystemSK])
REFERENCES [Typelist].[SourceSystem] ([SourceSystemSK])
GO
ALTER TABLE [Policy].[Watercraft] NOCHECK CONSTRAINT [FK_SourceSystemSK_Watercraft]
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This concept represents the features of most watercraft  including ships, boats, hovercraft and submarines' , @level0type=N'SCHEMA',@level0name=N'Policy', @level1type=N'TABLE',@level1name=N'Watercraft'
GO
