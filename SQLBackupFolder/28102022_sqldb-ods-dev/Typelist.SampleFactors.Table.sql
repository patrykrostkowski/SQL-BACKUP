USE [sqldb-ods-dev]
GO
/****** Object:  Table [Typelist].[SampleFactors]    Script Date: 28.10.2022 13:37:47 ******/
SET ANSI_NULLS ON
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'No table or column definition is required.  This is just a Example of rating factors' , @level0type=N'SCHEMA',@level0name=N'Typelist', @level1type=N'TABLE',@level1name=N'SampleFactors'
GO
