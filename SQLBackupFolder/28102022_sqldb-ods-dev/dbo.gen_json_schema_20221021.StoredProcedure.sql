USE [sqldb-ods-dev]
GO
/****** Object:  StoredProcedure [dbo].[gen_json_schema_20221021]    Script Date: 28.10.2022 11:11:04 ******/
SET ANSI_NULLS ON
GO
...
create   procedure [dbo].[gen_json_schema_20221021] @domain varchar(10), @debug varchar(1) = '0', @att_name varchar(100) = 'Root', @parent varchar(100) = null, @master varchar(100) = null, @att_type varchar(100) = null, @path varchar(1000) = null
as
--exec [dbo].[gen_json_schema] 'Policy', '1' --debug set to ON
...
open c_fields  
fetch next from c_fields into @c_rowno, @c_level, @c_parent, @c_master, @c_att_name, @c_att_type, @c_keyfield, @c_description, @c_db_table, @c_db_column, @c_dbdatatype
