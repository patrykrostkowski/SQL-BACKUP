USE [sqldb-ods-dev]
GO
/****** Object:  StoredProcedure [StgPolicy].[LoadSrcTables]    Script Date: 28.10.2022 15:06:01 ******/
SET ANSI_NULLS ON
GO
...
drop table if exists [StgPolicy].[SrcPolicyCoverage]
select * into [StgPolicy].[SrcPolicyCoverage]
from [StgPolicy].[InputSrcPolicyCoverage]
--EXEC sp_refreshview 'StgPolicy.StgPolicyCoverage'
GO
