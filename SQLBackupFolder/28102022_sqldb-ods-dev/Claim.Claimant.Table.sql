USE [sqldb-ods-dev]
GO
/****** Object:  Table [Claim].[Claimant]    Script Date: 28.10.2022 13:36:13 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_AK1_Claimant]    Script Date: 28.10.2022 13:37:52 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_AK1_Claimant] ON [Claim].[Claimant]
(
	[SourceSystemSK] ASC,
	[SourceCode] ASC,
	[ProcessDateTime] ASC
...
GO
ALTER TABLE [Claim].[Claimant]  WITH NOCHECK ADD  CONSTRAINT [FK_ClaimCurrencySK_Claimant] FOREIGN KEY([ClaimCurrencySK])
REFERENCES [Typelist].[Currency] ([CurrencySK])
GO
ALTER TABLE [Claim].[Claimant] NOCHECK CONSTRAINT [FK_ClaimCurrencySK_Claimant]
GO
ALTER TABLE [Claim].[Claimant]  WITH NOCHECK ADD  CONSTRAINT [FK_ClaimSK_Claimant] FOREIGN KEY([ClaimSK])
REFERENCES [Claim].[Claim] ([ClaimSK])
GO
ALTER TABLE [Claim].[Claimant] NOCHECK CONSTRAINT [FK_ClaimSK_Claimant]
GO
ALTER TABLE [Claim].[Claimant]  WITH NOCHECK ADD  CONSTRAINT [FK_PartySK_Claimant] FOREIGN KEY([PartySK])
REFERENCES [Party].[PartyMaster] ([PartySK])
GO
ALTER TABLE [Claim].[Claimant] NOCHECK CONSTRAINT [FK_PartySK_Claimant]
GO
ALTER TABLE [Claim].[Claimant]  WITH NOCHECK ADD  CONSTRAINT [FK_SourceSystemSK_Claimant] FOREIGN KEY([SourceSystemSK])
REFERENCES [Typelist].[SourceSystem] ([SourceSystemSK])
GO
ALTER TABLE [Claim].[Claimant] NOCHECK CONSTRAINT [FK_SourceSystemSK_Claimant]
GO
ALTER TABLE [Claim].[Claimant]  WITH NOCHECK ADD  CONSTRAINT [FK_VehicleStateSK_Claimant] FOREIGN KEY([VehicleStateSK])
REFERENCES [Typelist].[State] ([StateSK])
GO
ALTER TABLE [Claim].[Claimant] NOCHECK CONSTRAINT [FK_VehicleStateSK_Claimant]
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The party seeking financial restitution for a claim associated to one or more policies inforce at the time of the claim.' , @level0type=N'SCHEMA',@level0name=N'Claim', @level1type=N'TABLE',@level1name=N'Claimant'
GO
