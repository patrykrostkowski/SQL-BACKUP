USE [sqldb-ods-dev]
GO
/****** Object:  Table [PreBind].[QuoteDwelling]    Script Date: 28.10.2022 11:10:11 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_AK1_QuoteDwelling]    Script Date: 28.10.2022 11:11:04 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_AK1_QuoteDwelling] ON [PreBind].[QuoteDwelling]
(
	[SourceSystemSK] ASC,
	[SourceCode] ASC,
	[ProcessDateTime] ASC
...
GO
ALTER TABLE [PreBind].[QuoteDwelling]  WITH NOCHECK ADD  CONSTRAINT [FK_QuotePropertySK_QuoteDwelling] FOREIGN KEY([QuotePropertySK])
REFERENCES [PreBind].[QuoteProperty] ([QuotePropertySK])
GO
ALTER TABLE [PreBind].[QuoteDwelling] NOCHECK CONSTRAINT [FK_QuotePropertySK_QuoteDwelling]
GO
ALTER TABLE [PreBind].[QuoteDwelling]  WITH NOCHECK ADD  CONSTRAINT [FK_SourceSystemSK_QuoteDwelling] FOREIGN KEY([SourceSystemSK])
REFERENCES [Typelist].[SourceSystem] ([SourceSystemSK])
GO
ALTER TABLE [PreBind].[QuoteDwelling] NOCHECK CONSTRAINT [FK_SourceSystemSK_QuoteDwelling]
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This concept gives particular features of a dwelling. A dwelling can be further described by a dwelling description (DwellingDetail) and completely described by specifying each of its composing elements: rooms, cellars, garages, etc.' , @level0type=N'SCHEMA',@level0name=N'PreBind', @level1type=N'TABLE',@level1name=N'QuoteDwelling'
GO
