USE [sqldb-ods-dev]
GO
/****** Object:  Table [PreBind].[QuoteDriver]    Script Date: 28.10.2022 13:36:58 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_AK1_QuoteDriver]    Script Date: 28.10.2022 13:37:52 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_AK1_QuoteDriver] ON [PreBind].[QuoteDriver]
(
	[SourceSystemSK] ASC,
	[SourceCode] ASC,
	[ProcessDateTime] ASC
...
GO
ALTER TABLE [PreBind].[QuoteDriver]  WITH NOCHECK ADD  CONSTRAINT [FK_DriverLicenseStateSK_QuoteDriver] FOREIGN KEY([DriverLicenseStateSK])
REFERENCES [Typelist].[State] ([StateSK])
GO
ALTER TABLE [PreBind].[QuoteDriver] NOCHECK CONSTRAINT [FK_DriverLicenseStateSK_QuoteDriver]
GO
ALTER TABLE [PreBind].[QuoteDriver]  WITH NOCHECK ADD  CONSTRAINT [FK_DriverRoleTypeSK_QuoteDriver] FOREIGN KEY([DriverRoleTypeSK])
REFERENCES [Typelist].[DriverRoleType] ([DriverRoleTypeSK])
GO
ALTER TABLE [PreBind].[QuoteDriver] NOCHECK CONSTRAINT [FK_DriverRoleTypeSK_QuoteDriver]
GO
ALTER TABLE [PreBind].[QuoteDriver]  WITH NOCHECK ADD  CONSTRAINT [FK_PartySK_QuoteDriver] FOREIGN KEY([PartySK])
REFERENCES [Party].[PartyMaster] ([PartySK])
GO
ALTER TABLE [PreBind].[QuoteDriver] NOCHECK CONSTRAINT [FK_PartySK_QuoteDriver]
GO
ALTER TABLE [PreBind].[QuoteDriver]  WITH NOCHECK ADD  CONSTRAINT [FK_SourceSystemSK_QuoteDriver] FOREIGN KEY([SourceSystemSK])
REFERENCES [Typelist].[SourceSystem] ([SourceSystemSK])
GO
ALTER TABLE [PreBind].[QuoteDriver] NOCHECK CONSTRAINT [FK_SourceSystemSK_QuoteDriver]
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A person specified as a driver whose  name(s)  appears in the policy and/or policy declarations as a driver, and not as an excluded driver.' , @level0type=N'SCHEMA',@level0name=N'PreBind', @level1type=N'TABLE',@level1name=N'QuoteDriver'
GO
