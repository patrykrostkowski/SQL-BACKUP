...
GO
/****** Object:  Table [Production].[ProductCategory]    Script Date: 02.11.2022 13:42:36 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [AK_ProductCategory_Name]    Script Date: 02.11.2022 13:42:36 ******/
CREATE UNIQUE NONCLUSTERED INDEX [AK_ProductCategory_Name] ON [Production].[ProductCategory]
(
	[Name] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [AK_ProductCategory_rowguid]    Script Date: 02.11.2022 13:42:36 ******/
