USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[PolicyLossHistory]    Script Date: 12.11.2022 09:01:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BaseCurrencySK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BaseCurrencySK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
ALTER TABLE [Policy].[PolicyLossHistory] CHECK CONSTRAINT [FK_BaseCurrencySK_PolicyLossHistory]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ClaimCoverageSK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ClaimCoverageSK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
ALTER TABLE [Policy].[PolicyLossHistory] CHECK CONSTRAINT [FK_ClaimCoverageSK_PolicyLossHistory]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyCoverageSK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyCoverageSK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
ALTER TABLE [Policy].[PolicyLossHistory] CHECK CONSTRAINT [FK_PolicyCoverageSK_PolicyLossHistory]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicySK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicySK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
ALTER TABLE [Policy].[PolicyLossHistory] CHECK CONSTRAINT [FK_PolicySK_PolicyLossHistory]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_PolicyLossHistory]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyLossHistory]'))
