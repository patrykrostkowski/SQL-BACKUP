USE [DataMagnifier]
GO
/****** Object:  Table [PreBind].[QuotePropertyVehicleDetail]    Script Date: 12.11.2022 09:01:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuotePropertySK_QuotePropertyVehicleDetail]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuotePropertySK_QuotePropertyVehicleDetail]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]'))
ALTER TABLE [PreBind].[QuotePropertyVehicleDetail] CHECK CONSTRAINT [FK_QuotePropertySK_QuotePropertyVehicleDetail]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteVehicleSK_QuotePropertyVehicleDetail]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteVehicleSK_QuotePropertyVehicleDetail]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]'))
ALTER TABLE [PreBind].[QuotePropertyVehicleDetail] CHECK CONSTRAINT [FK_QuoteVehicleSK_QuotePropertyVehicleDetail]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuotePropertyVehicleDetail]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuotePropertyVehicleDetail]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuotePropertyVehicleDetail]'))
