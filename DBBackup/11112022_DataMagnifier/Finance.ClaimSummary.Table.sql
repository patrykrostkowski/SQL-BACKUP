USE [DataMagnifier]
GO
/****** Object:  Table [Finance].[ClaimSummary]    Script Date: 12.11.2022 09:01:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Finance].[ClaimSummary]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_AnnualStatementLineofBusinessSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_AnnualStatementLineofBusinessSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
ALTER TABLE [Finance].[ClaimSummary] CHECK CONSTRAINT [FK_AnnualStatementLineofBusinessSK_ClaimSummary]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_BaseCurrencySK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_BaseCurrencySK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
ALTER TABLE [Finance].[ClaimSummary] CHECK CONSTRAINT [FK_BaseCurrencySK_ClaimSummary]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_ClaimCoverageSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_ClaimCoverageSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
ALTER TABLE [Finance].[ClaimSummary] CHECK CONSTRAINT [FK_ClaimCoverageSK_ClaimSummary]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_ClaimSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_ClaimSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
ALTER TABLE [Finance].[ClaimSummary] CHECK CONSTRAINT [FK_ClaimSK_ClaimSummary]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_DomicileStateSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_DomicileStateSK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
ALTER TABLE [Finance].[ClaimSummary] CHECK CONSTRAINT [FK_DomicileStateSK_ClaimSummary]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_OriginalCurrencySK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_OriginalCurrencySK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
ALTER TABLE [Finance].[ClaimSummary] CHECK CONSTRAINT [FK_OriginalCurrencySK_ClaimSummary]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_ReportingCurrencySK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
...
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Finance].[FK_ReportingCurrencySK_ClaimSummary]') AND parent_object_id = OBJECT_ID(N'[Finance].[ClaimSummary]'))
