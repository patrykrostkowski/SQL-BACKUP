USE [DataMagnifier]
GO
/****** Object:  Table [PreBind].[QuoteAircraftLocation]    Script Date: 10.11.2022 14:36:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_CountrySK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_CountrySK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
ALTER TABLE [PreBind].[QuoteAircraftLocation] CHECK CONSTRAINT [FK_CountrySK_QuoteAircraftLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteAircraftSK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteAircraftSK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
ALTER TABLE [PreBind].[QuoteAircraftLocation] CHECK CONSTRAINT [FK_QuoteAircraftSK_QuoteAircraftLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
ALTER TABLE [PreBind].[QuoteAircraftLocation] CHECK CONSTRAINT [FK_SourceSystemSK_QuoteAircraftLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_StateSK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_StateSK_QuoteAircraftLocation]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteAircraftLocation]'))
