USE [DataMagnifier]
GO
/****** Object:  View [StgPolicy].[SrcNorthAmericanIndustryClassification]    Script Date: 10.11.2022 14:36:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[StgPolicy].[SrcNorthAmericanIndustryClassification]'))
