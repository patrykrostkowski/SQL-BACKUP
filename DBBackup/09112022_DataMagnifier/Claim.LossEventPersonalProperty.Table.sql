USE [DataMagnifier]
GO
/****** Object:  Table [Claim].[LossEventPersonalProperty]    Script Date: 10.11.2022 14:36:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_LossEventSK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_LossEventSK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
ALTER TABLE [Claim].[LossEventPersonalProperty] CHECK CONSTRAINT [FK_LossEventSK_LossEventPersonalProperty]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_PropertyCountrySK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_PropertyCountrySK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
ALTER TABLE [Claim].[LossEventPersonalProperty] CHECK CONSTRAINT [FK_PropertyCountrySK_LossEventPersonalProperty]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_PropertyStateSK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_PropertyStateSK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
ALTER TABLE [Claim].[LossEventPersonalProperty] CHECK CONSTRAINT [FK_PropertyStateSK_LossEventPersonalProperty]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_SourceSystemSK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_SourceSystemSK_LossEventPersonalProperty]') AND parent_object_id = OBJECT_ID(N'[Claim].[LossEventPersonalProperty]'))
