USE [DataMagnifier]
GO
/****** Object:  Table [PreBind].[QuoteTrans]    Script Date: 10.11.2022 14:36:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_AddressTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_AddressTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_AddressTypeSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_AgencySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_AgencySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_AgencySK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_BaseCurrencySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans]  WITH CHECK ADD  CONSTRAINT [FK_BaseCurrencySK_QuoteTrans] FOREIGN KEY([BaseCurrencySK])
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_BaseCurrencySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_BaseCurrencySK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_BillTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_BillTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_BillTypeSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_BusinessUnitSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_BusinessUnitSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_BusinessUnitSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_ClassCodeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_ClassCodeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_ClassCodeSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DirectAssumedSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DirectAssumedSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_DirectAssumedSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DomicileCountrySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DomicileCountrySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_DomicileCountrySK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DomicileStateSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans]  WITH CHECK ADD  CONSTRAINT [FK_DomicileStateSK_QuoteTrans] FOREIGN KEY([DomicileStateSK])
REFERENCES [TypeList].[State] ([StateSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DomicileStateSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_DomicileStateSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_LineSlipSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_LineSlipSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_LineSlipSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_NorthAmericanIndustryClassificationSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_NorthAmericanIndustryClassificationSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_NorthAmericanIndustryClassificationSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_PricingLevelSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_PricingLevelSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_PricingLevelSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_ProgramSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_ProgramSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_ProgramSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_ProjectTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_ProjectTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_ProjectTypeSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteInsuredSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans]  WITH CHECK ADD  CONSTRAINT [FK_QuoteInsuredSK_QuoteTrans] FOREIGN KEY([QuoteInsuredSK])
REFERENCES [Party].[PartyMaster] ([PartySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteInsuredSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_QuoteInsuredSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteLifecycleTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteLifecycleTypeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_QuoteLifecycleTypeSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_QuoteSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteStateSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans]  WITH CHECK ADD  CONSTRAINT [FK_QuoteStateSK_QuoteTrans] FOREIGN KEY([QuoteStateSK])
REFERENCES [TypeList].[State] ([StateSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteStateSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_QuoteStateSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_SourceSystemSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_StandardIndustryCodeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_StandardIndustryCodeSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_StandardIndustryCodeSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_UnderwriterSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans]  WITH CHECK ADD  CONSTRAINT [FK_UnderwriterSK_QuoteTrans] FOREIGN KEY([UnderwriterSK])
REFERENCES [Party].[PartyMaster] ([PartySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_UnderwriterSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_UnderwriterSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_UnderwritingStatusSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_UnderwritingStatusSK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
ALTER TABLE [PreBind].[QuoteTrans] CHECK CONSTRAINT [FK_UnderwritingStatusSK_QuoteTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_WritingCompanySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_WritingCompanySK_QuoteTrans]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteTrans]'))
