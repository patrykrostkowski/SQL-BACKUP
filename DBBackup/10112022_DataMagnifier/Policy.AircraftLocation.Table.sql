USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[AircraftLocation]    Script Date: 10.11.2022 14:43:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[AircraftLocation]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_AircraftSK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_AircraftSK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
ALTER TABLE [Policy].[AircraftLocation] CHECK CONSTRAINT [FK_AircraftSK_AircraftLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_CountrySK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_CountrySK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
ALTER TABLE [Policy].[AircraftLocation] CHECK CONSTRAINT [FK_CountrySK_AircraftLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
ALTER TABLE [Policy].[AircraftLocation] CHECK CONSTRAINT [FK_SourceSystemSK_AircraftLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_StateSK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
ALTER TABLE [Policy].[AircraftLocation]  WITH CHECK ADD  CONSTRAINT [FK_StateSK_AircraftLocation] FOREIGN KEY([StateSK])
REFERENCES [TypeList].[State] ([StateSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_StateSK_AircraftLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[AircraftLocation]'))
