USE [DataMagnifier]
GO
/****** Object:  Table [Party].[PartyMaster]    Script Date: 10.11.2022 14:43:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Party].[PartyMaster]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_DriverLicenseStateSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_DriverLicenseStateSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
ALTER TABLE [Party].[PartyMaster] CHECK CONSTRAINT [FK_DriverLicenseStateSK_PartyMaster]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_OwnershipTypeSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_OwnershipTypeSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
ALTER TABLE [Party].[PartyMaster] CHECK CONSTRAINT [FK_OwnershipTypeSK_PartyMaster]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_PartyTypeSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_PartyTypeSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
ALTER TABLE [Party].[PartyMaster] CHECK CONSTRAINT [FK_PartyTypeSK_PartyMaster]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_SourceSystemSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Party].[FK_SourceSystemSK_PartyMaster]') AND parent_object_id = OBJECT_ID(N'[Party].[PartyMaster]'))
