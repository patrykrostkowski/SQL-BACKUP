USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[PolicyTrans]    Script Date: 10.11.2022 14:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[PolicyTrans]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BaseCurrencySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans]  WITH CHECK ADD  CONSTRAINT [FK_BaseCurrencySK_PolicyTrans] FOREIGN KEY([BaseCurrencySK])
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BaseCurrencySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_BaseCurrencySK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BusinessTypeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BusinessTypeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_BusinessTypeSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BusinessUnitSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BusinessUnitSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_BusinessUnitSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_CoverageTriggerSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_CoverageTriggerSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_CoverageTriggerSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DomicileCountrySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DomicileCountrySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_DomicileCountrySK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DomicileStateSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DomicileStateSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_DomicileStateSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_NorthAmericanIndustryClassificationSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_NorthAmericanIndustryClassificationSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_NorthAmericanIndustryClassificationSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_OriginalCurrencySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_OriginalCurrencySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_OriginalCurrencySK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_PolicySK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyTransStatusSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyTransStatusSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_PolicyTransStatusSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyTransTypeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyTransTypeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_PolicyTransTypeSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ProfessionSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ProfessionSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_ProfessionSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ProjectTypeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ProjectTypeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_ProjectTypeSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ReportingCurrencySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ReportingCurrencySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_ReportingCurrencySK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_SourceSystemSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_StandardIndustryCodeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_StandardIndustryCodeSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_StandardIndustryCodeSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_UnderwritingStatusPolicyT272]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_UnderwritingStatusPolicyT272]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_UnderwritingStatusPolicyT272]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_UnderwritingStatusSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
REFERENCES [TypeList].[UnderwritingStatus] ([UnderwritingStatusSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_UnderwritingStatusSK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
ALTER TABLE [Policy].[PolicyTrans] CHECK CONSTRAINT [FK_UnderwritingStatusSK_PolicyTrans]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_WritingCompanySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_WritingCompanySK_PolicyTrans]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicyTrans]'))
