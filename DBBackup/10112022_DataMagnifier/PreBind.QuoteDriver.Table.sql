USE [DataMagnifier]
GO
/****** Object:  Table [PreBind].[QuoteDriver]    Script Date: 10.11.2022 14:35:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DriverLicenseStateSK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DriverLicenseStateSK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
ALTER TABLE [PreBind].[QuoteDriver] CHECK CONSTRAINT [FK_DriverLicenseStateSK_QuoteDriver]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DriverRoleTypeSK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_DriverRoleTypeSK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
ALTER TABLE [PreBind].[QuoteDriver] CHECK CONSTRAINT [FK_DriverRoleTypeSK_QuoteDriver]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_PartySK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
ALTER TABLE [PreBind].[QuoteDriver]  WITH CHECK ADD  CONSTRAINT [FK_PartySK_QuoteDriver] FOREIGN KEY([PartySK])
REFERENCES [Party].[PartyMaster] ([PartySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_PartySK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
ALTER TABLE [PreBind].[QuoteDriver] CHECK CONSTRAINT [FK_PartySK_QuoteDriver]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteDriver]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteDriver]'))
