USE [DataMagnifier]
GO
/****** Object:  Table [dbo].[DIMCalendarDay]    Script Date: 10.11.2022 14:43:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DIMCalendarDay]') AND type in (N'U'))
BEGIN
