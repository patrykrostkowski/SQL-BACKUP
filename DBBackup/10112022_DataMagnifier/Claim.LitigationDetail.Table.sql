USE [DataMagnifier]
GO
/****** Object:  Table [Claim].[LitigationDetail]    Script Date: 10.11.2022 14:35:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Claim].[LitigationDetail]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_LitigationSK_LitigationDetail]') AND parent_object_id = OBJECT_ID(N'[Claim].[LitigationDetail]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_LitigationSK_LitigationDetail]') AND parent_object_id = OBJECT_ID(N'[Claim].[LitigationDetail]'))
ALTER TABLE [Claim].[LitigationDetail] CHECK CONSTRAINT [FK_LitigationSK_LitigationDetail]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_SourceSystemSK_LitigationDetail]') AND parent_object_id = OBJECT_ID(N'[Claim].[LitigationDetail]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Claim].[FK_SourceSystemSK_LitigationDetail]') AND parent_object_id = OBJECT_ID(N'[Claim].[LitigationDetail]'))
