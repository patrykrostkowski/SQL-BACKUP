USE [DataMagnifier]
GO
/****** Object:  Table [TypeList].[RiskRating]    Script Date: 10.11.2022 14:47:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TypeList].[RiskRating]') AND type in (N'U'))
BEGIN
