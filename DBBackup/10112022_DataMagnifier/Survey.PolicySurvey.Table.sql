USE [DataMagnifier]
GO
/****** Object:  Table [Survey].[PolicySurvey]    Script Date: 10.11.2022 14:35:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Survey].[PolicySurvey]') AND type in (N'U'))
BEGIN
