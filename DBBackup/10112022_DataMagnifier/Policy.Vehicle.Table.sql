USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[Vehicle]    Script Date: 10.11.2022 14:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[Vehicle]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyInsurableObjectSK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyInsurableObjectSK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
ALTER TABLE [Policy].[Vehicle] CHECK CONSTRAINT [FK_PolicyInsurableObjectSK_Vehicle]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_RegistrationCountrySK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_RegistrationCountrySK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
ALTER TABLE [Policy].[Vehicle] CHECK CONSTRAINT [FK_RegistrationCountrySK_Vehicle]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_RegistrationStateSK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_RegistrationStateSK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
ALTER TABLE [Policy].[Vehicle] CHECK CONSTRAINT [FK_RegistrationStateSK_Vehicle]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
ALTER TABLE [Policy].[Vehicle]  WITH CHECK ADD  CONSTRAINT [FK_SourceSystemSK_Vehicle] FOREIGN KEY([SourceSystemSK])
REFERENCES [TypeList].[SourceSystem] ([SourceSystemSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_Vehicle]') AND parent_object_id = OBJECT_ID(N'[Policy].[Vehicle]'))
