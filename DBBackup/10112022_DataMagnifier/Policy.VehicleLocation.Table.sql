USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[VehicleLocation]    Script Date: 10.11.2022 14:20:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[VehicleLocation]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_CountrySK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_CountrySK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
ALTER TABLE [Policy].[VehicleLocation] CHECK CONSTRAINT [FK_CountrySK_VehicleLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
ALTER TABLE [Policy].[VehicleLocation] CHECK CONSTRAINT [FK_SourceSystemSK_VehicleLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_StateSK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
ALTER TABLE [Policy].[VehicleLocation]  WITH CHECK ADD  CONSTRAINT [FK_StateSK_VehicleLocation] FOREIGN KEY([StateSK])
REFERENCES [TypeList].[State] ([StateSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_StateSK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
ALTER TABLE [Policy].[VehicleLocation] CHECK CONSTRAINT [FK_StateSK_VehicleLocation]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_VehicleSK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_VehicleSK_VehicleLocation]') AND parent_object_id = OBJECT_ID(N'[Policy].[VehicleLocation]'))
