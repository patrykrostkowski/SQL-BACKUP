USE [DataMagnifier]
GO
/****** Object:  Table [PreBind].[QuoteVehicle]    Script Date: 10.11.2022 14:20:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PreBind].[QuoteVehicle]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteInsurableObjectSK_QuoteVehicle]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteVehicle]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_QuoteInsurableObjectSK_QuoteVehicle]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteVehicle]'))
ALTER TABLE [PreBind].[QuoteVehicle] CHECK CONSTRAINT [FK_QuoteInsurableObjectSK_QuoteVehicle]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteVehicle]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteVehicle]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[PreBind].[FK_SourceSystemSK_QuoteVehicle]') AND parent_object_id = OBJECT_ID(N'[PreBind].[QuoteVehicle]'))
