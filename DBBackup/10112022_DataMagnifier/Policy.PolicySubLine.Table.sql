USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[PolicySubLine]    Script Date: 10.11.2022 14:20:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[PolicySubLine]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BaseCurrencySK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_BaseCurrencySK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
ALTER TABLE [Policy].[PolicySubLine] CHECK CONSTRAINT [FK_BaseCurrencySK_PolicySubLine]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_OriginalCurrencySK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
...
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_OriginalCurrencySK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
ALTER TABLE [Policy].[PolicySubLine] CHECK CONSTRAINT [FK_OriginalCurrencySK_PolicySubLine]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyLineofBusinessSK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PolicyLineofBusinessSK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
ALTER TABLE [Policy].[PolicySubLine] CHECK CONSTRAINT [FK_PolicyLineofBusinessSK_PolicySubLine]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ReportingCurrencySK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
...
REFERENCES [TypeList].[Currency] ([CurrencySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_ReportingCurrencySK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
ALTER TABLE [Policy].[PolicySubLine] CHECK CONSTRAINT [FK_ReportingCurrencySK_PolicySubLine]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
ALTER TABLE [Policy].[PolicySubLine] CHECK CONSTRAINT [FK_SourceSystemSK_PolicySubLine]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SublineSK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SublineSK_PolicySubLine]') AND parent_object_id = OBJECT_ID(N'[Policy].[PolicySubLine]'))
