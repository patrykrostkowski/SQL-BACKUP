USE [Test]
GO
/****** Object:  View [dbo].[test_policydata]    Script Date: 10.11.2022 14:36:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[test_policydata]'))
EXEC dbo.sp_executesql @statement = N'
CREATE view [dbo].[test_policydata]
as
select 
