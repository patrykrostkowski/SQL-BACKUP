USE [Test]
GO
/****** Object:  View [dbo].[v_test_policydata]    Script Date: 10.11.2022 14:35:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[v_test_policydata]'))
