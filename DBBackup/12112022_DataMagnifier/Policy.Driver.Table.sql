USE [DataMagnifier]
GO
/****** Object:  Table [Policy].[Driver]    Script Date: 12.11.2022 09:01:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Policy].[Driver]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DriverLicenseStateSK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DriverLicenseStateSK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
ALTER TABLE [Policy].[Driver] CHECK CONSTRAINT [FK_DriverLicenseStateSK_Driver]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DriverRoleTypeSK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_DriverRoleTypeSK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
ALTER TABLE [Policy].[Driver] CHECK CONSTRAINT [FK_DriverRoleTypeSK_Driver]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PartySK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
ALTER TABLE [Policy].[Driver]  WITH CHECK ADD  CONSTRAINT [FK_PartySK_Driver] FOREIGN KEY([PartySK])
REFERENCES [Party].[PartyMaster] ([PartySK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_PartySK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
ALTER TABLE [Policy].[Driver] CHECK CONSTRAINT [FK_PartySK_Driver]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
ALTER TABLE [Policy].[Driver]  WITH CHECK ADD  CONSTRAINT [FK_SourceSystemSK_Driver] FOREIGN KEY([SourceSystemSK])
REFERENCES [TypeList].[SourceSystem] ([SourceSystemSK])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Policy].[FK_SourceSystemSK_Driver]') AND parent_object_id = OBJECT_ID(N'[Policy].[Driver]'))
