...
GO
/****** Object:  Table [Sales].[SalesTaxRate]    Script Date: 17.11.2022 17:53:07 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Index [AK_SalesTaxRate_rowguid]    Script Date: 17.11.2022 17:53:07 ******/
CREATE UNIQUE NONCLUSTERED INDEX [AK_SalesTaxRate_rowguid] ON [Sales].[SalesTaxRate]
(
	[rowguid] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [AK_SalesTaxRate_StateProvinceID_TaxType]    Script Date: 17.11.2022 17:53:07 ******/
